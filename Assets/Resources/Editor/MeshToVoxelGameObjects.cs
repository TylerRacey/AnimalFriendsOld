...
//        {
//            Vector3 vertice1 = selectedGameObject.transform.position + vertices[indices[i * 3]];
//            Vector3 vertice2 = selectedGameObject.transform.position + vertices[indices[i * 3 + 1]];
//            Vector3 vertice3 = selectedGameObject.transform.position + vertices[indices[i * 3 + 2]];
